...
superherofacts_token_docs = superherofacts.load_and_split(text_splitter=token_splitter)

# Print token-based chunks
print("Token-based Chunks:")
for doc in superherofacts_token_docs:
    print(doc.page_content)
    print("\n")

# Collect token-based chunk sizes
token_chunk_sizes = [len(doc.page_content) for doc in superherofacts_token_docs]
